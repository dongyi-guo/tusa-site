...
Some incident might happen such as:

- Your club's store stops taking payments, or
...
- Go to your **Club's Main Page**
- Navigate with tab **Club Admin \> Bank Signatories**
- Complete and submit the Request-to-Change Form
...
**No**. Once connected, your Stripe account stays connected through reaffiliation.

### What if our president changes?

The Stripe account is connected to the club, not the individual. TUSA staff update the representative when the president changes.
...
- Contact the Clubs team at clubs@tusa.utas.edu.au for any Stripe or payment issues.
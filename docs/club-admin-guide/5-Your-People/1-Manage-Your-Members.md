...
As mentioned in the membership chapter, membership products are used to segue your customers to club members. In fact, **members should ONLY join by purchasing membership from your store.**
...
Usually you don't need to worry about your members as it is a must-resolve during affiliation or reaffiliation. However, there are some cases you may need to take action.
...
- Go to Store Manager > Team

- Search for the person or create a new account

- Add them as store staff

This gives them store access without group admin powers.
...
There are some situations you may want to remove members immediately:
...
For a complete removal, you need to contact TUSA. They can:
...
Your club may have a massive number of members, setting them up one by one could be daunting. However, the **Member Import** tool and **Club Stat/Member Export** tool can be helpful if  you have a list of members to import (e.g., from a legacy system or external spreadsheet).

Both tools work with CSV, the spreadsheet will require columns such as:

...
- Have emergency contact information if needed
- Meet legal and insurance requirements
- Get proper consent for specific activities

Completing these forms is part of participating in club events. They’re not optional when requested.
...
- Most club events and activities
- Sports and physical activities
- Outdoor adventures (bushwalks, camping)
...
- Adventure activities (camping, bushwalking, water activities)
- Sports and physical events
- Overnight trips
- Any activity where medical conditions could be relevant

**What you provide:**

- Your name
- Any medical conditions organisers should know about
- Allergies (especially food, insect stings, medications)
- Current medications
...
- Attending any club event or activity
...
**Note:** If you’re under 18, you cannot attend events without this form completed by your parent or guardian.
...
1.  Tell you which forms are required when you sign up
...
3.  Read the terms/acknowledgements carefully
...
- **Submit on time** – Late forms may mean you can’t attend
- **Keep a copy** – Screenshot or save confirmation for your records
...
- If you have a condition that could affect your safety, not disclosing it puts you at risk
...
- Expect to complete all three forms (waiver, medical, possibly parental)
...
- Medical information critical for multi-day activities
...
1.  Alert the event organiser immediately
...
- Contact TUSA directly
- Your privacy is important and concerns are taken seriously
